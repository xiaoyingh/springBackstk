				...
				<div class="modal-body">
					<div class="panel-wrap">
						...
						<c:forEach items="${typeb }" var="bs">
							...
							first="初中"; second="${bs.typeName }"; third=""; firstid="190"; secondid="${bs.ID }"; thirdid="";
							...
							<c:forEach items="${asd }" var="bsd">
							 ...
							 <option first="初中"; second="${bs.typeName }"; third="${bsd.typeName }"; firstid="190"; secondid="${bs.ID }"; thirdid="${bsd.ID }";>
...
var path=localhostPaht+projectName;
        ...
        function xxvideo(obj) {
          ...
          //alert(page);
          window.location.href='<%=path%>/backml?id=190&page='+page;
...
<script type="text/javascript" src="<%=path%>/js/iframepage/chpublic.js"></script>
