				...
				<c:if test="${dis == 1 }">
					<div class="pager">
						...
						<nav aria-label="Page navigation">
							<ul class="pagination">
								<li><a href="selcodenotuse?page=1">首页</a></li>

								<c:if test="${info.hasPreviousPage }">
									<li><a href="selcodenotuse?page=${info.pageNum-1 }"
								...
								<c:forEach items="${info.navigatepageNums }" var="page_Num">
									<c:if test="${page_Num == info.pageNum }">
										<li class="active"><a
											href="selcodenotuse?page=${page_Num }">${page_Num }</a></li>
									</c:if>

									<c:if test="${page_Num != info.pageNum }">
										<li><a href="selcodenotuse?page=${page_Num }">${page_Num }</a></li>
									</c:if>
								</c:forEach>
								...
								<li><a href="selcodenotuse?page=${info.pages }">末页</a></li>
							</ul>
						</nav>
					</div>
